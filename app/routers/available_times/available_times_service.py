...
from app.internal.exception.errorcode import available_times_error_code
...
class AvailableTimesService:
    ...
    def create_available_time(self, dto: AvailableTimeCreate) -> AvailableTimes:
        ...
        try:
            ...
            raise ControlledException(available_times_error_code.DUPLICATE_KEY) from e
    ...
    def find_by_id(self, available_time_id: int) -> AvailableTimes:
        ...
        if not item:
            raise ControlledException(available_times_error_code.AVAILABLE_TIME_NOT_FOUND)
        return item
