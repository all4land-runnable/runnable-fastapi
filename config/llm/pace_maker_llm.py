...
class PaceMakerLLM(CommonLLM):
    ...
    _PACE_TEMPLATE = ("system", dedent("""
        ...
        * Each Object:
          ...
          - "strategies":str 각종 정보를 통해 도출된 구간별 러닝 전략 
        </WRITING_GUIDELINES>

        <OUTPUT_SCHEMA>
        {{
        "result": [
            {{"distance":<이동거리 1>,"pace":<맞춤 페이스 1>, "strategies":<맞춤 전략 1>}},
            {{"distance":<이동거리 2>,"pace":<맞춤 페이스 2>, "strategies":<맞춤 전략 2>}},
            {{"distance":<이동거리 3>,"pace":<맞춤 페이스 3>, "strategies":<맞춤 전략 3>}},
            {{"distance":<이동거리 4>,"pace":<맞춤 페이스 4>, "strategies":<맞춤 전략 4>}},
            ...
        ]
        }}
        </OUTPUT_SCHEMA>
        ...
        A. {{"result":[{{"distance":50,"pace":420,"strategies":"여의공원로를 따라 349m 이동 구간은 평지입니다. 7’00’’ 페이스를 유지하세요!\n"}},{{"distance":100,"pace":428,"strategies":"은행로 6m 구간은 완만한 오르막입니다. 7’08’’ 페이스를 유지하세요!\n"}},{{"distance":150,"pace":412,"strategies":"국회의사당역 1번출구 구간은 완만한 내리막입니다. 6’52’’ 페이스를 유지해주세요!\n"}},{{"distance":200,"pace":420,"strategies":"국회의사당 인근은 평지이며 목적지에 거의 다 도착했습니다. 7’00’’ 페이스를 유지하세요!\n"}}]}}
        ...
        A. {{"result":[{{"distance":50,"pace":318,"strategies":"어드롭렛인카페 앞 오르막 시작 구간입니다. 보폭을 줄이고 5’18’’ 페이스를 유지하세요!\n"}},{{"distance":100,"pace":326,"strategies":"용두동홍쭈꾸미 방향 가파른 오르막입니다. 팔 치기를 적극적으로 사용하며 5’26’’ 페이스를 유지하세요!\n"}},{{"distance":150,"pace":334,"strategies":"좌회전 후 141m 이동 구간은 더 가파른 오르막입니다. 호흡을 일정하게 유지하며 5’34’’ 페이스로 가세요!\n"}},{{"distance":200,"pace":346,"strategies":"나물먹는곰까지 매우 가파른 경사입니다. 과도한 무릎 굴곡을 피하고 5’46’’ 페이스를 유지하세요!\n"}}]}}
        ...
        A. {{"result":[{{"distance":50,"pace":407,"strategies":"신길광장공원앞 구간은 완만한 오르막이며 짐 6kg의 영향이 있습니다. 6’47’’ 페이스를 유지하세요!\n"}},{{"distance":100,"pace":387,"strategies":"보행자도로, 24m 구간은 완만한 내리막입니다. 과속을 피하고 6’27’’ 페이스를 유지하세요!\n"}},{{"distance":150,"pace":419,"strategies":"우신떡방앗간 앞은 가파른 오르막입니다. 보폭을 줄이고 상체를 약간 세워 6’59’’ 페이스를 유지하세요!\n"}},{{"distance":200,"pace":371,"strategies":"신길로, 192m 구간은 가파른 내리막입니다. 착지 충격을 줄이며 6’11’’ 페이스를 유지하세요!\n"}}]}}
        </RETURN_EXAMPLE>
